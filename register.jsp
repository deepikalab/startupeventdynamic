...
<body>
<form action="StartProcessRequest" method="POST" name="form1" onsubmit="return myfun() && myfun2()">
	...
	<input type="text" placeholder="Email ID" name="mailid">
	</div>
	
   <div>
	<label for="Password">Password</label>
	<input id="password" type="Password" placeholder="Password" name="pwd1" value="" onblur='myfun();'>
	</div>
	
	<div>
	<label for="Confirm Password">Confirm Password</label>
	<input id="confirm_password" type="Password" placeholder="Re-Type password" name="pwd2" value="" onblur='myfun();'>
	...
	<input type="text" placeholder="College Name" name="colg">
	</div>
	
	<div>
	<label for="Department">Department</label>
	<select id="department" name="department" onblur="myfun()">
