...
<form action="validate2.jsp" method="POST">
	...
	<input type="text" placeholder="Username" name="lgusername">
	</div>
	
	<div>
	<label for="Email ID">Email ID</label>
	<input type="text" placeholder="Email ID" name="lgmail">
	</div>
	
	<div>
	<label for="Password">Password</label>
	<input type="Password" placeholder="Password" name="lgpwd1">
	</div>
